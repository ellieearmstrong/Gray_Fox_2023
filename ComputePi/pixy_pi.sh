...
#SBATCH --time=01:00:00 #ten hour run time
...
##compute pi in 100kb windows for each chromosome

pixy --stats pi --vcf /scratch1/jazlynmo/grayfox/vcf/Mainland/"$infile".gvcf.gz --populations /scratch1/jazlynmo/grayfox/metaData/pops_pixy_n12.txt --window_size 100000 --chromosomes "chr"$CHROM --bypass_invariant_check 'yes' --n_cores 32 --output_folder /scratch1/jazlynmo/grayfox/Analyses/pi/output_pi/ --output_prefix $infile"_"$CHROM
...
pixy --stats pi --vcf /scratch1/jazlynmo/grayfox/vcf/ChannelIsland/"$infile".gvcf.gz --populations /scratch1/jazlynmo/grayfox/metaData/pops_pixy_ChannelIsland.txt --window_size 100000 --chromosomes "chr"$CHROM --bypass_invariant_check 'yes' --n_cores 32 --output_folder /scratch1/jazlynmo/grayfox/Analyses/pi/output_pi_ChannelIsland/ --output_prefix $infile"_"$CHROM
