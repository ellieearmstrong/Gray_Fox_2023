...
#SBATCH --output=/scratch/users/elliea/jazlyn-ellie/grayfox_2023/logfiles/pi_%a_af.out  #you will need to modify the path
#SBATCH --error=/scratch/users/elliea/jazlyn-ellie/grayfox_2023/logfiles/pi_%a_af.err  #you will need to modify the path
