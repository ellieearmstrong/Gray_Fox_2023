#!/bin/sh
#SBATCH --job-name=pi
#SBATCH --output=/scratch/users/elliea/jazlyn-ellie/grayfox_2023/logfiles/pi_%a_C3.out  #you will need to modify the path
#SBATCH --error=/scratch/users/elliea/jazlyn-ellie/grayfox_2023/logfiles/pi_%a_C3.err  #you will need to modify the path
