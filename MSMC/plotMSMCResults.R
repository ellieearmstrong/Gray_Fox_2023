...
library(data.table)
library(mgsub)
setwd("~/Documents/Gray_Fox_2023/MSMC")
...
mu=4.69e-8#Tanya Autosomal Mutation Rate for Neutral cm >0.4 and 1years/gen
gen=1 #(years/gen)
...
ggplot(results25, 
       aes(x=LeftYears,y=Ne, colour=Population))+
  ...
  scale_x_log10(breaks=c(100,1000,10000,100000,1000000, 10000000, 100000000, 1000000000, 10000000000),labels=comma) + 
  ...
  geom_vline(xintercept = 8000, color="black")
