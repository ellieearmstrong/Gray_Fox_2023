#!/bin/sh
#SBATCH --job-name=pi24
#SBATCH --output=/scratch1/jazlynmo/grayfox/logfiles/pi_%a_24.out  #you will need to modify the path
#SBATCH --error=/scratch1/jazlynmo/grayfox/logfiles/pi_%a_24.err  #you will need to modify the path
...
done < gvcfIn_Mainland_chr24.txt
