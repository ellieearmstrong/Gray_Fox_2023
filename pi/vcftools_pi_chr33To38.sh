#!/bin/sh
#SBATCH --job-name=pi38
#SBATCH --output=/scratch1/jazlynmo/grayfox/logfiles/pi_%a_38.out  #you will need to modify the path
#SBATCH --error=/scratch1/jazlynmo/grayfox/logfiles/pi_%a_38.err  #you will need to modify the path
...
done < gvcfIn_Mainland_chr38.txt
