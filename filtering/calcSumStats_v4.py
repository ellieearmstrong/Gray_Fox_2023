...
calculate_statistics('filtered_canFam3.1_gvcfstats.DP_NMISS_Mainland_rmSRR24465295.out')
calculate_statistics('filtered_arcticfox_gvcfstats.DP_NMISS_Mainland_rmSRR24465295.out')
calculate_statistics('filtered_canFam4_gvcfstats.DP_NMISS_Mainland_rmSRR24465295.out')
calculate_statistics('filtered_grayfox_gvcfstats.DP_NMISS_Mainland_rmSRR24465295.out')
