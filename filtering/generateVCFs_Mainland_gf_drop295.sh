...
SECONDS=0
bcftools filter -i 'AN > 59 && INFO/DP > 204 && INFO/DP < 501'  /scratch/users/elliea/jazlyn-ellie/grayfox_filtered.renameChroms.Mainland.gvcf.gz -Oz -o  /scratch/users/elliea/jazlyn-ellie/grayfox_filtered.renameChroms.Mainland.drop295.ACgr59_DPgr205lt500.gvcf.gz
echo $SECONDS
