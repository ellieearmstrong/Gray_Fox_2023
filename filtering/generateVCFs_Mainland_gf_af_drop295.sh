...
SECONDS=0
bcftools filter -e 'AC < 61 || INFO/DP < 205 || INFO/DP > 500' /scratch/users/elliea/jazlyn-ellie/grayfox_2023/vcf/grayfox_filtered.renameChroms.Mainland.drop295.gvcf.gz -Oz -o /scratch/users/elliea/jazlyn-ellie/grayfox_2023/vcf/grayfox_filtered.renameChroms.Mainland.drop295.ACgr25_DPgr165lt500.gvcf.gz
echo $SECONDS
...
##Filtering based on depth and allele count
#SECONDS=0
#bcftools filter -e 'AC < 61 || INFO/DP < 205 || INFO/DP > 500' /scratch/users/elliea/jazlyn-ellie/grayfox_2023/vcf/arcticfox_filtered.renameChroms.Mainland.drop295.gvcf.gz -Oz -o /scratch/users/elliea/jazlyn-ellie/grayfox_2023/vcf/arcticfox_filtered.renameChroms.Mainland.drop295.ACgr25_DPgr165lt500.gvcf.gz
#echo $SECONDS
