...
##Filtering based on depth and allele count
SECONDS=0
bcftools filter -e 'AC > 59 && INFO/DP > 204 && INFO/DP < 501' /scratch/users/elliea/jazlyn-ellie/grayfox_2023/vcf/Canfam4_filtered.renameChroms.Mainland.drop295.gvcf.gz -Oz -o /scratch/users/elliea/jazlyn-ellie/grayfox_2023/vcf/Canfam4_filtered.renameChroms.Mainland.drop295.ACgr25_DPgr165lt500.gvcf.gz
echo $SECONDS
